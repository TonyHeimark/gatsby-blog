  ...
  <Layout>
    ...
    <Container>
      <div className="contact-wrapper">
        ...
        <a className="icon-link" href="https://github.com/TonyHeimark" target="_blank">
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fab"
        ...
        <a className="icon-link" href="https://www.linkedin.com/in/tony-j-heimark/" target="_blank">
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fab"
