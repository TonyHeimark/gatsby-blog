  ...
  <Layout>
    ...
    <Container>
      <div className="privacy-wrapper">
        <h1 className="privacy-wrapper__title">Privacy Policy</h1>
        <div>
          ...
          <ol>
            ...
            <li>
              Consenting to our use of cookies in accordance with the terms of this policy when you
              first visit our website permits us to use cookies every time you visit our website.
            </li>
          </ol>
          <h3>B. Credit</h3>
          <p>
            This document was created using a template from SEQ Legal (seqlegal.com) and modified by
            Website Planet (www.websiteplanet.com)
          </p>
          <h3>C. Collecting personal information</h3>
          ...
          <ol>
            ...
            <li>
              information about your visits to and use of this website including the referral
              source, length of visit, page views, and website navigation paths;
            </li>
            <li>
              information, such as your name and email address, that you enter when you send form
              submissions with our website;
            </li>
            <li>
              information, such as your name and email address, that you enter in order to set up
            ...
            <li>
              information contained in any communications that you send to us by email or through
          ...
          <h3>D. Using your personal information</h3>
          <p>
            Personal information submitted to us through our website will be used for the purposes
            specified in this policy or on the relevant pages of the website. We may use your
          ...
          <ol>
            ...
            <li>
              providing third parties with statistical information about our users (but those third
          ...
          <h3>E. Disclosing personal information</h3>
          <p>
            We may disclose your personal information to any of our employees, officers, insurers,
            professional advisers, agents, suppliers, or subcontractors as reasonably necessary for
          ...
          <h3>F. International data transfers</h3>
          <ol>
            <li>
              Information that we collect may be stored, processed in, and transferred between any
              of the countries in which we operate in order to enable us to use the information in
              accordance with this policy.
            </li>
            <li>
              Information that we collect may be transferred to the following countries which do not
            ...
            <li>
              Personal information that you publish on our website or submit for publication on our
          ...
          <h3>G. Retaining personal information</h3>
          <ol>
            <li>
              This Section G sets out our data retention policies and procedure, which are designed
              to help ensure that we comply with our legal obligations regarding the retention and
              deletion of personal information.
            </li>
            <li>
              Personal information that we process for any purpose or purposes shall not be kept for
              longer than is necessary for that purpose or those purposes.
            </li>
            <li>
              Without prejudice to article G-2, we will usually delete personal data falling within
              the categories set out below at the date/time set out below:
              <ol>
                <li>personal data like IP adresses will be deleted within 30 days; and</li>
              </ol>
            </li>
            <li>
              Notwithstanding the other provisions of this Section G, we will retain documents
          ...
          <h3>H Security of your personal information</h3>
          <ol>
            <li>
              We will take reasonable technical and organizational precautions to prevent the loss,
          ...
          <p>
            ...
            and obtained from cookies. both session and persistent cookies on our website.
          </p>
          <ol>
            <li>
              <strong>
                The names of the cookies that we use on our website, and the purposes for which they
                are used, are set out below:
              </strong>
              <ol>
                <li>
                  we use Google Analytics and Adwords on our website to recognize a computer when a
            ...
            <li>
              <strong>Most browsers allow you to refuse to accept cookies—for example:</strong>
              <ol>
                <li>
                  in Internet Explorer (version 10) you can block cookies using the cookie handling
                  override settings available by clicking “Tools,” “Internet Options,” “Privacy,”
                  and then “Advanced”;
                </li>
                <li>
                  in Firefox (version 24) you can block all cookies by clicking “Tools,” “Options,”
            ...
            <li>
              <strong>You can delete cookies already stored on your computer—for example:</strong>
              <ol>
                <li>
                  in Internet Explorer (version 10), you must manually delete cookie files (you can
                  find instructions for doing so at http://support.microsoft.com/kb/278835 );
                </li>
                <li>
                  2. in Firefox (version 24), you can delete cookies by clicking “Tools,” “Options,”
                  and “Privacy”, then selecting “Use custom settings for history”, clicking “Show
                  Cookies,” and then clicking “Remove All Cookies”; and
                </li>
                <li>
                  3. in Chrome (version 29), you can delete all cookies by accessing the “Customize
                  and control” menu, and clicking “Settings,” “Show advanced settings,” and “Clear
                  browsing data,” and then selecting “Delete cookies and other site and plug-in
